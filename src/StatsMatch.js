...
const pointMessages = totalPoints => {
  ...
  else if (totalPoints >= 60) { return 'I may not know your phone number but I remember your name!' } else if (totalPoints >= 50) return 'Fine Friends'
  else if (totalPoints >= 40) { return 'Maybe if you talked less, I would like you more..' } else if (totalPoints >= 30) return 'Totally Friendzoned'
